...
export const experiences: Experience[] = [
  {
    ...
    highlights: [
      'Led the design and implementation of the company\'s core platform from the ground up, architecting a scalable microservices-based system across key domains (ERP, POS, HRM, CRM, E-Commerce, E-Learning), supporting 50+ store locations and 1000+ active employees.',
      'Designed and implemented event-driven microservices using AWS (EC2, SQS, SNS, Lambda, API Gateway, RDS, S3), ensuring high availability and cost-efficiency.',
      ...
      'Built observability into the system from day one with CloudWatch (metrics, alarms, log groups), X-Ray for distributed tracing, and structured JSON logging with correlation IDs — cut average debugging time by 40%.',
      ...
      'Built and mentored a high-performing engineering team (4+ interns converted to full-time), establishing strong coding standards, fostering Agile (Scrum/Kanban) culture, and translating technical decisions for stakeholders in business terms (cost, risk, impact).',
    ],
    technologies: ['Node.js', 'NestJS', 'TypeScript', 'React', 'Next.js', 'Python', 'Django', 'PostgreSQL', 'MySQL', 'Redis', 'AWS', 'Jest'],
  },
  {
    id: 2,
  ...
  {
    id: 3,
    company: 'CLOUDJET CORPORATE',
    title: 'Full Stack Developer',
    period: '01/2023 — 05/2024',
    description: 'A cloud-based ERP platform for SMEs — covering process standardization, KPI evaluation, HR, and operational reporting.',
    highlights: [
      'Developed Django REST APIs for core ERP modules (KPI management, goal-setting workflows, employee evaluation) used by 200+ business clients to run quarterly performance reviews.',
      'Built ERP dashboards with React and Redux — KPI scorecards, department-level reports, and approval workflows that replaced spreadsheet-based operations across client organizations.',
      'Implemented role-based access control (RBAC) across ERP modules with NestJS Guards, ensuring department managers only accessed their own team\'s KPI data and approval queues.',
      'Optimized heavy reporting queries in PostgreSQL by adding composite indexes and cursor-based pagination, bringing KPI summary APIs from 8s+ down to under 500ms.',
      'Built a configurable report export engine (PDF/Excel) using Celery background tasks, letting clients schedule and auto-deliver monthly KPI reports to stakeholders via email.',
      'Integrated RabbitMQ for async event handling — KPI review notifications, approval reminders, and scheduled report delivery without blocking the main request flow.',
      'Participated in code reviews, sprint planning, and on-call rotation — handled production incidents and wrote post-mortems to prevent recurrence.',
    ],
    technologies: ['Java', 'Spring Boot', 'Python', 'Django', 'Node.js', 'NestJS', 'React', 'Redux', 'PostgreSQL', 'Redis', 'RabbitMQ', 'Docker', 'Git'],
  },
];
